...
class ClassBalancedLoss(torch.nn.Module):
    def __init__(self, samples_per_class=None,num_classes = 7, is_smoothing=False, beta=0.9999, gamma=2, loss_type="focal", weights_factors:Optional[torch.Tensor] = None):
        ...
        if weights_factors is not None:
            weights = weights*np.array(weights_factors)
